...
Template.dental_payment.events({
    ...
    'click .insert': function () {
        ...
        Meteor.setTimeout(function () {
            alertify.payment(fa("plus", "Payment"), renderTemplate(Template.dental_paymentInsert, data));
        }, 500);
    },
    'click .update': function () {
        var data = Dental.Collection.Payment.findOne({_id: this._id});
        alertify.payment(fa("pencil", "Payment"), renderTemplate(Template.dental_paymentUpdate, data));
    },
